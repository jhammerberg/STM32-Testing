...
/* Definitions for blinky01 */
osThreadId_t blinky01Handle;
const osThreadAttr_t blinky01_attributes = {
  .name = "blinky01",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for blinky02 */
osThreadId_t blinky02Handle;
const osThreadAttr_t blinky02_attributes = {
  .name = "blinky02",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for blinky03 */
osThreadId_t blinky03Handle;
const osThreadAttr_t blinky03_attributes = {
  .name = "blinky03",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
...
/* USER CODE BEGIN Header_StartBlinky01 */
/**
  * @brief  Function implementing the blinky01 thread.
...
/* USER CODE BEGIN Header_StartBlinky02 */
/**
* @brief Function implementing the blinky02 thread.
* @param argument: Not used
* @retval None
*/
...
void StartBlinky02(void *argument)
{
  ...
  osThreadTerminate(NULL);
  /* USER CODE END StartBlinky02 */
}

/* USER CODE BEGIN Header_StartBlinky03 */
/**
* @brief Function implementing the blinky03 thread.
* @param argument: Not used
* @retval None
*/
