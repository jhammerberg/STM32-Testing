...
/* Definitions for get_data */
osThreadId_t get_dataHandle;
const osThreadAttr_t get_data_attributes = {
  .name = "get_data",
  .stack_size = 512 * 4,
...
void start_get_data(void *argument);
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of get_data */
  get_dataHandle = osThreadNew(start_get_data, NULL, &get_data_attributes);
...
/* USER CODE BEGIN Header_start_get_data */
/**
  * @brief  Function implementing the get_data thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_start_get_data */
void start_get_data(void *argument)
{
  /* init code for LWIP */
  MX_LWIP_Init();
